...
public class C_ReducidoLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"SI", "SINO", "IMPRIMIR", "RETORNAR", "PAREN_ABRE", "PAREN_CIERRA", "LLAVE_ABRE", 
			"LLAVE_CIERRA", "PUNTO_COMA", "CERO", "UNO", "LETRA", "DIGITO", "SIMBOLO", 
			"CADENA", "IGNORAR_ESPACIOS"
		};
	}
	...
	public C_ReducidoLexer(CharStream input) {
		super(input);
